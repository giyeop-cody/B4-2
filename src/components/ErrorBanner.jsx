export default function ErrorBanner({ message = '요청에 실패했습니다. 다시 시도하세요.', onRetry }) {
  return (
    <div role="alert" aria-live="polite" style={{ border: '1px solid #fecaca', background: '#fef2f2', borderRadius: 8, padding: '20px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
